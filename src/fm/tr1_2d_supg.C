...
contextIOResultType TR1_2D_SUPG :: saveContext(DataStream &stream, ContextMode mode)
//
...
contextIOResultType TR1_2D_SUPG :: restoreContext(DataStream &stream, ContextMode mode)
//
