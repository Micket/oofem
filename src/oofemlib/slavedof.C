...
contextIOResultType SlaveDof :: saveContext(DataStream &stream, ContextMode mode)
{
...
contextIOResultType SlaveDof :: restoreContext(DataStream &stream, ContextMode mode)
{
    contextIOResultType iores;
