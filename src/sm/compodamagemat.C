...
contextIOResultType CompoDamageMatStatus :: saveContext(DataStream &stream, ContextMode mode)
{
...
contextIOResultType CompoDamageMatStatus :: restoreContext(DataStream &stream, ContextMode mode) {
    contextIOResultType iores;
