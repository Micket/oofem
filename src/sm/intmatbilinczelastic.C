...
#if 0
contextIOResultType
IntMatBilinearCZElasticStatus :: saveContext(DataStream &stream, ContextMode mode)
{
...
contextIOResultType
IntMatBilinearCZElasticStatus :: restoreContext(DataStream &stream, ContextMode mode)
{
    contextIOResultType iores;
