...
contextIOResultType MicroMaterialStatus :: saveContext(DataStream &stream, ContextMode mode)
{
    return CIO_OK;
}

contextIOResultType MicroMaterialStatus :: restoreContext(DataStream &stream, ContextMode mode)
{
    return CIO_OK;
}
